export const it = {
  ...
  about: {
    title: "Chi Siamo - MareSereno",
    subtitle: "Scopri la storia, la visione e l'impegno che rendono MareSereno una destinazione eccezionale.",
    description: "Fin dalla nostra apertura, MareSereno si è affermato come punto di riferimento nell'ospitalità di lusso sul mare. La nostra passione per l'eccellenza e la dedizione al servizio personalizzato creano esperienze indimenticabili per ogni ospite.",
    story: {
      title: "La Nostra Storia",
      content: "Fondato con la visione di creare un santuario di lusso sul Mediterraneo, MareSereno fonde armoniosamente architettura moderna e bellezza naturale. Ogni dettaglio della nostra struttura è stato progettato per offrire un'esperienza autentica e raffinata."
    },
    mission: {
      title: "La Nostra Missione",
      content: "Ci impegniamo a fornire un'ospitalità eccezionale che superi le aspettative, creando momenti preziosi e ricordi duraturi per i nostri ospiti in un ambiente di incomparabile bellezza naturale."
    },
    values: {
      ...
      items: [
        {
          title: "Eccellenza",
          description: "Perseguiamo l'eccellenza in ogni aspetto del vostro soggiorno."
        },
        {
          title: "Autenticità",
          description: "Celebriamo la cultura locale e l'ospitalità mediterranea."
        },
        {
          title: "Sostenibilità",
          description: "Rispettiamo e preserviamo il nostro ambiente naturale."
        },
        {
          title: "Innovazione",
          description: "Abbracciamo le ultime tecnologie per migliorare la vostra esperienza."
        }
      ]
    },
    team: {
      title: "Il Nostro Team",
      description: "Il nostro team dedicato di professionisti dell'ospitalità lavora instancabilmente per assicurare che ogni momento del vostro soggiorno sia perfetto."
    }
  }
};

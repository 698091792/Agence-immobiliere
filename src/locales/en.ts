export const en = {
  ...
  hero: {
    subtitle: "BEACHFRONT LUXURY ACCOMMODATION OF KRIBIBEACH",
  ...
  testimonials: {
    ...
    description: "Discover why our guests keep coming back to KribiBeach for their seaside getaways."
  },
  notFound: {
  ...
  home: {
    welcome: {
      subtitle: "Welcome to KribiBeach",
      title: "Luxury Seaside Accommodations",
      description1: "Nestled on the pristine Mediterranean coastline, KribiBeach offers an exquisite collection of luxury apartments and hotel rooms. Our beachfront accommodations combine elegant design with modern comfort, creating the perfect setting for an unforgettable seaside getaway.",
  ...
  amenitiesPage: {
    ...
    description: "At KribiBeach, we are dedicated to providing a comprehensive and luxurious stay experience. From our beachfront services to wellness facilities, every detail has been curated to ensure maximum comfort and pleasure.",
    categories: {
      wellness: {
  ...
  about: {
    title: "About KribiBeach",
    subtitle: "Discover the story, vision, and commitment that make KribiBeach an exceptional destination.",
    description: "Since our opening, KribiBeach has established itself as a reference in luxury seaside hospitality. Our passion for excellence and dedication to personalized service create unforgettable experiences for every guest.",
    story: {
      title: "Our Story",
      content: "Founded with the vision of creating a luxury sanctuary by the Mediterranean, KribiBeach harmoniously blends modern architecture with natural beauty. Every detail of our property has been designed to offer an authentic and refined experience."
    },
    mission: {
      title: "Our Mission", 
      content: "We are committed to delivering exceptional hospitality that exceeds expectations, creating precious moments and lasting memories for our guests in a setting of incomparable natural beauty."
    },
    values: {
      title: "Our Values",
      items: [
        {
          title: "Excellence",
          description: "We pursue excellence in every aspect of your stay."
        },
        {
          title: "Authenticity", 
          description: "We celebrate local culture and Mediterranean hospitality."
        },
        {
          title: "Sustainability",
          description: "We respect and preserve our natural environment."
        },
        {
          title: "Innovation",
          description: "We embrace the latest technologies to enhance your experience."
        }
      ]
    },
    team: {
      title: "Our Team",
      description: "Our dedicated team of hospitality professionals works tirelessly to ensure every moment of your stay is perfect."
    }
  }
};
